...
console.log(`Số lượng ảnh: ${numGroups}, Điểm mỗi ảnh: ${pointsPerGroup} - script.js:115`);
...
const ringTexts = [
  'Galaxy of love From Masnul',//untuk deskripsi planet layer 1
  "I love you Zumalain",//untuk deskripsi planet layer 2
  "♡Happy Girlfriend day♡",//untuk deskripsi planet layer 3
  "26/09/2025",//untuk deskripsi planet layer 4
...
function playGalaxyAudio() {
  if (galaxyAudio) {
    galaxyAudio.play().catch(err => {
      console.warn("Audio play blocked or delayed: - script.js:807", err);
    });
  }
}
preloadGalaxyAudio();
